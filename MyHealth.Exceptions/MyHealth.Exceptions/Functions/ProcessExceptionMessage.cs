...
namespace MyHealth.Exceptions.Functions
{
    public class ProcessExceptionMessage
    {
        ...
        public async Task Run([ServiceBusTrigger("myhealthexceptiontopic", "myhealthexceptionsubscription", Connection = "FunctionsOptions:ServiceBusConnectionString")] string incomingExceptionMessage)
        {
            try
            {
